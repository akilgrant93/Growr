              ...
              flex:1,
                ...
                {/* neeeds indoors and tags modularity */}
                  ...
                  onPress={() => navigation.navigate('UpdateModal',item)}>
                    <View style={{ flexDirection: 'row',overflow:'hidden',justifyContent: 'space-between', shadowOpacity: .25,shadowOffset: {width:1,height:1}, shadowRadius: 2, borderRadius: 5, backgroundColor: '#fff' }}>
                      ...
                      <View style={styles.textView}>
                        ...
                        {item.isIndoors ?<HomeModernIcon color={'#034732'} size={20}/> :
                        <SunIcon color={'#034732'} size={20}/>}
                        {item.isHydroponic ? <Svg width={20}height={20} fill={'#034732'} viewBox="0 0 792 612">
                          <G>
                        ...
                        {item.isPotted ?
                        <Svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} fill={'#034732'}viewBox="0 0 792 612">
